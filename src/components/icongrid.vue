<template>
    ...
    >
        ...
        <div class="selection" ref="selection" :style="selectionArea"></div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            mousedown: function (evt) {
                ...
                this.selectionArea.display = "block";
            },
            ...
            mouseup: function () {
                this.selectionArea.display = "none"
            ...
            enter: function () {
                this.$refs.icons.forEach(i => {
                    if(i.iconSelected && this.selectionArea.display == "none") {
                        let appId = i.id
