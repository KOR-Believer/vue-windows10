<template>
    ...
    >
        <i class="icon-image">
            <img src="../assets/images/icongrid/pinterest_icon.png" alt="icon">
        </i>
...
<style scoped>
    ...
    .icon:hover:after {
        background: rgba(143, 203, 252, 0.1);
        border: 1px solid rgba(143, 203, 252, 0);
        box-shadow: inset 0px 0px 0px 1px #a9a8cb;
    }
